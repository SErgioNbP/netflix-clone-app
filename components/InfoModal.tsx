import Reac, { useCallback, useEffect, useState } from 'react';
...
const InfoModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
  ...
  return (
    <div
      className="z-50 transition duration-300 bg-black bg-opacity-80
        ...
        >
          <div className="relative h-96">
            ...
            <div
              ...
              rounded-full bg-black bg-opacity-70 flex justify-center
              items-center"
              onClick={handleClose}
            >
            ...
            <div className="absolute bottom-[10%] left-10">
              <p
                ...
                h-full lg:text-5xl font-bold mb-8"
              >
                {data?.title}
              </p>
